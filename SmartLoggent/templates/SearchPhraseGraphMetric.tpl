<div style="width: 250px; height: 250px; Float: Left" id="{$properties.uniqueId}" class="dataTable">
	...
	{if $isDataAvailable}
		...
		<div class="jqplot-{$graphType}" style="padding-left: 6px;">
			<div id="{$chartDivId}" class="piwik-graph" style="position: relative; width: 250px; height: 250px;"></div>
		</div>
